...
<head>
    ...
    <?php echo error_handler_css(); ?>

    <style>
        .pre > code:nth-child(2) {
            display: none;
        }
        #frame-0 .hljs-ln-line[data-line-number='10'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-1 .hljs-ln-line[data-line-number='40'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-2 .hljs-ln-line[data-line-number='238'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-3 .hljs-ln-line[data-line-number='209'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-4 .hljs-ln-line[data-line-number='806'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-20 .hljs-ln-line[data-line-number='805'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-21 .hljs-ln-line[data-line-number='784'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-22 .hljs-ln-line[data-line-number='748'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-23 .hljs-ln-line[data-line-number='737'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-24 .hljs-ln-line[data-line-number='200'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-38 .hljs-ln-line[data-line-number='57'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-43 .hljs-ln-line[data-line-number='1183'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
...
<div class="renderer container mx-auto lg:px-8">
    <header class="mt-3 px-5 sm:mt-10">
        ...
        systemMode() {
            ...
            setDarkClass()
                        ...
                        <button class="block rounded p-1 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-400 dark:text-gray-600 hover:text-gray-500 focus:text-gray-500 dark:hover:text-gray-500 dark:focus:text-gray-500"
                        ...
                        <div x-show="menu"
                            ...
                            <button class="flex items-center gap-3 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400"
                            ...
                            <button class="flex items-center gap-3 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-900 dark:text-gray-100"
    ...
    <main class="px-6 pb-12 pt-6">
        <div class="container mx-auto">
            <?php require __DIR__ . '/partials/heading.php' ?>
            <?php require __DIR__ . '/partials/trace.php' ?>
            <?php require __DIR__ . '/partials/request.php' ?>
            <?php require __DIR__ . '/partials/application.php' ?>
        </div>
    </main>
</div>

<?php echo error_handler_js(); ?>
